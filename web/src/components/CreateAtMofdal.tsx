...
import CheckboxI from './../assets/Checkbox.svg';
...
export function CreateAtModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    try {
      ...
      console.log(error)
      alert('Você não consegiu achar seu duo')
    }
    ...
    top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25' >
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
            name='name' id="name" placeholder="Como te chamam dentro do game?" />
          </div>
          ...
          <label className="mt-2 flex gap-2 items-center text-sm">
            ...
            className='w-6 h-6 p-1 rounded bg-zinc-900'>
              <Checkbox.Indicator>
                <img src={CheckboxI} className="w-4 h-4" />
              </Checkbox.Indicator>
            </Checkbox.Root>
          ...
          <footer className="mt-4 flex justify-end gap-4">
            ...
            >
              <img src={GameController} className="w-6 h-6" />
              Encontrar duo
            </button>
          </footer>
        </form>
